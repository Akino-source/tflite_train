...
# Train the model
model = object_detector.create(train_data, model_spec=spec, batch_size=16, train_whole_model=True, epochs=200, validation_data=val_data)
...
# Export the model
model.export(export_dir='.', tflite_filename='pig_health.tflite')

# Evaluate the tflite model
tflite_eval_result = model.evaluate_tflite('pig_health.tflite', val_data)
